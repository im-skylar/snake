...
set showcmd
set smarttab
set statusline=%f\ %m\ %{WordCount()}\ Words%=%c,%l/%L\ |\ %P
...
silent only
silent tabonly
cd ~/Documents/Programming/rust-learn/snake
...
badd +0 src/main.rs
badd +0 src/game.rs
badd +0 src/game/apple.rs
badd +0 src/game/snake.rs
badd +0 src/utils.rs
argglobal
%argdel
$argadd src/main.rs
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 131 + 94) / 189)
exe 'vert 2resize ' . ((&columns * 1 + 94) / 189)
exe 'vert 3resize ' . ((&columns * 55 + 94) / 189)
argglobal
balt src/main.rs
setlocal keymap=
setlocal noarabic
...
silent! normal! zE
let &fdl = &fdl
let s:l = 89 - ((28 * winheight(0) + 21) / 43)
...
wincmd w
argglobal
if bufexists(fnamemodify("src/utils.rs", ":p")) | buffer src/utils.rs | else | edit src/utils.rs | endif
balt src/main.rs
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 15 - ((11 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 15
normal! 0
lcd ~/Documents/Programming/rust-learn/snake
wincmd w
argglobal
if bufexists(fnamemodify("~/Documents/Programming/rust-learn/snake/src/game/snake.rs", ":p")) | buffer ~/Documents/Programming/rust-learn/snake/src/game/snake.rs | else | edit ~/Documents/Programming/rust-learn/snake/src/game/snake.rs | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
